...
summary: 'NetApp offre supporto per la NetApp Console in diversi modi. Sono disponibili numerose opzioni di auto-supporto gratuite 24x7, come articoli della knowledgebase (KB) e un forum della community. La registrazione al supporto include supporto tecnico remoto tramite ticket web.' 
---
= Ottieni aiuto
:allow-uri-read: 
:icons: font
...
== Ottieni supporto per un cloud provider file service
...
* Se stai aprendo una richiesta di assistenza per un sistema ONTAP che ha un numero di serie, il tuo account NSS deve essere associato al numero di serie di quel sistema.
...
+
.. Seleziona *Call Us* se vuoi parlare con qualcuno al telefono. Verrai reindirizzato a una pagina su netapp.com che elenca i numeri di telefono che puoi chiamare.
...
+
image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/screenshot-create-case.png["Uno screenshot del modulo \"Crea un caso\" che ti permette di creare un caso con il supporto NetApp."]



.Dopo aver finito
Si aprirà una finestra pop-up con il numero della tua richiesta di assistenza. Uno specialista del Supporto NetApp esaminerà la tua richiesta e ti ricontatterà presto.

Per visualizzare la cronologia delle tue richieste di assistenza, seleziona *Impostazioni > Cronologia* e cerca le azioni denominate "create support case". Un pulsante all'estrema destra ti consente di espandere l'azione per vedere i dettagli.
...
+
** La schermata a sinistra mostra il numero totale di casi aperti negli ultimi 3 mesi dall'utente con l'account NSS che hai fornito.
...
+
I risultati nella tabella riflettono i casi relativi alla visualizzazione che hai selezionato.
...
+
** *Visualizza il caso*: Visualizza tutti i dettagli relativi a uno specifico caso.
